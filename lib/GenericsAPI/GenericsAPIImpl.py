...
class GenericsAPI:
    ...
    GIT_COMMIT_HASH = "65e28477d66a9283085cd44d280d0098f9a9452f"
    ...
    def run_pca(self, ctx, params):
        ...
        :param params: instance of type "PCAParams" (Input of the run_pca
           ...
           PCA (KBaseExperiments.PCAMatrix) object n_components - number of
           components (default 2)) -> structure: parameter "input_obj_ref" of
           type "obj_ref" (An X/Y/Z style reference), parameter
           "workspace_name" of String, parameter "pca_matrix_name" of String,
           parameter "n_components" of Long
